...
class Handlelogin(View):
    def get(self,request,*args,**kwargs):
        account = True
        return render(request, "shop/login1.html", {"account": account})
    def post(self,request,*args,**kwargs):
        if request.method == 'POST':
...
class Handlesignup(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        recommend = {"pr2": [1, "shop/images/john_player_tshirt.jpg", "John Player Tshirt (L/M/XXL)", 2],
                     "pr6": [1, "shop/images/lancer_shoes.jpg", "Lancer Shoes", 6],
                     "pr7": [1, "shop/images/levis_jeans.jpg", "Levis Jeans", 7]}
...
class Handlelogout(View):
    def post(self,request,*args,**kwargs):
        ...
        logout(request)
        logoutt = True
        return render(request, "shop/login1.html", {"logout": logoutt});
    def get(self,request,*args,**kwargs):
        return render(request, "shop/login1.html");
